...
def generate_docx_report(image_buffer, prediction_label, confidence_score, confidence_percent, gradcam_buffer=None):
    ...
    doc.add_paragraph(
        """
        This report is generated by an artificial intelligence system and intended for assistive decision-making only. It does not constitute a final medical diagnosis. All findings should be reviewed and verified by a qualified radiologist or medical professional.
        """
    )
