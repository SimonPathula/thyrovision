...
from utils.model_architecture import Avg2MaxPooling, DWSCBlock, FibonacciConvBlock, FibonacciNet, PCB1, PCB2
from utils.logger import logger

# --- Page Config ---
st.set_page_config(page_title="Thyroid Cancer Detection", layout="centered")
st.markdown("""
    <style>
...
def main():
    st.title("ThyroVision: Thyroid Cancer Detection System")
